(function () {
    ...
    class CreateVersionStyling extends HTMLElement {
        constructor() {
            super();
        ...
        _submit(e) {
            e.preventDefault();
            let properties = {};
            for (let name of CreateVersionStyling.observedAttributes) {
    ...
    customElements.define("t4data-sac-widget-createversionstyling", CreateVersionStyling);
})();